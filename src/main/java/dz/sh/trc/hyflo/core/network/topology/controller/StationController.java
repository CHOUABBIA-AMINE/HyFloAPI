...
@RestController
@RequestMapping("/api/v1/network/stations")
@Tag(name = "Station API", description = "Endpoints for managing Station")
public class StationController extends BaseController<CreateStationRequest, UpdateStationRequest, StationResponse, StationSummary, Station, Long> {
