...
@Service
public class StructureServiceImpl extends AbstractCrudService<CreateStructureRequest, UpdateStructureRequest, StructureResponse, StructureSummary, Structure> implements StructureService {
