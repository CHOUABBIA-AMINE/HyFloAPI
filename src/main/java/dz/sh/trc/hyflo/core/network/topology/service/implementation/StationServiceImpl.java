...
@Service
public class StationServiceImpl extends AbstractCrudService<CreateStationRequest, UpdateStationRequest, StationResponse, StationSummary, Station, Long> implements StationService {
