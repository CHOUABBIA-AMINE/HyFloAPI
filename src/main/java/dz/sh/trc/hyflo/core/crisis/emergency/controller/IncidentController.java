...
public class IncidentController extends BaseController<CreateIncidentRequest, UpdateIncidentRequest, IncidentResponse, IncidentSummary, dz.sh.trc.hyflo.core.crisis.emergency.model.Incident, Long> {
