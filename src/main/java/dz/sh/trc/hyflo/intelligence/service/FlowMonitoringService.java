...
import dz.sh.trc.hyflo.intelligence.repository.IntelligenceQueryRepository;
import dz.sh.trc.hyflo.intelligence.util.DateTimeUtils;
...
public class FlowMonitoringService {
    ...
    /**
     * FIX: was imported as dz.sh.trc.hyflo.intelligence.facade.impl.IFlowReadingFacade
