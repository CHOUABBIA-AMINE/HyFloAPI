 ...
 *
 *  @Description: Maps intelligence.model entities to their read DTOs.
...
import dz.sh.trc.hyflo.intelligence.dto.FlowAnomalyReadDTO;
import dz.sh.trc.hyflo.intelligence.model.DataQualityIssue;
import dz.sh.trc.hyflo.intelligence.model.FlowAnomaly;

/**
 * Static utility mapper for intelligence entities → DTOs.
 */
