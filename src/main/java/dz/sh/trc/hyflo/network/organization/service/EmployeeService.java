...
import dz.sh.trc.hyflo.network.organization.dto.EmployeeDTO;
import dz.sh.trc.hyflo.network.organization.model.Employee;
import dz.sh.trc.hyflo.network.organization.model.Job;
import dz.sh.trc.hyflo.network.organization.model.Structure;
import dz.sh.trc.hyflo.network.organization.repository.EmployeeRepository;
