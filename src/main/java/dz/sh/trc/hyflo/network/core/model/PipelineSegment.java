...
public class PipelineSegment extends Infrastructure {
    ...
    @ManyToOne
    @JoinColumn(name="F_14", referencedColumnName = "F_00", foreignKey=@ForeignKey(name="T_02_02_09_FK_01"), nullable=true)
    private Alloy constructionMaterial;

    @ManyToOne
    @JoinColumn(name="F_15", referencedColumnName = "F_00", foreignKey=@ForeignKey(name="T_02_02_09_FK_02"), nullable=true)
    private Alloy exteriorCoating;

    @ManyToOne
    @JoinColumn(name="F_16", referencedColumnName = "F_00", foreignKey=@ForeignKey(name="T_02_02_09_FK_03"), nullable=true)
    private Alloy interiorCoating;

    @ManyToOne
    @JoinColumn(name="F_17", referencedColumnName = "F_00", foreignKey=@ForeignKey(name="T_02_02_09_FK_01"), nullable=false)
