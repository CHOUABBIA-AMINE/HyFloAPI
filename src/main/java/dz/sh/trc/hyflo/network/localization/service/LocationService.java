...
package dz.sh.trc.hyflo.network.localization.service;
...
import dz.sh.trc.hyflo.network.localization.dto.LocationDTO;
import dz.sh.trc.hyflo.network.localization.model.Locality;
import dz.sh.trc.hyflo.network.localization.model.Location;
import dz.sh.trc.hyflo.network.localization.repository.LocalityRepository;
import dz.sh.trc.hyflo.network.localization.repository.LocationRepository;
