...
package dz.sh.trc.hyflo.business.contract.model;

import java.util.Date;
import java.util.List;

import dz.sh.trc.hyflo.configuration.template.GenericModel;
import dz.sh.trc.hyflo.business.consultation.model.Consultation;
import dz.sh.trc.hyflo.business.core.model.ApprovalStatus;
import dz.sh.trc.hyflo.business.core.model.Currency;
import dz.sh.trc.hyflo.business.core.model.ProcurementStatus;
import dz.sh.trc.hyflo.business.plan.model.PlannedItem;
import dz.sh.trc.hyflo.business.provider.model.Provider;
