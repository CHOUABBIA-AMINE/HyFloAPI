...
package dz.sh.trc.hyflo.api.flow.planning.model;
...
import dz.sh.trc.hyflo.api.network.common.model.Product;
...
public class FlowForecast extends GenericModel {
    ...
    @Schema(description = "Predicted volume (cubic meters or barrels)", example = "28000.00",
            requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Forecast accuracy percentage (0-100%)", example = "98.5",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED)
