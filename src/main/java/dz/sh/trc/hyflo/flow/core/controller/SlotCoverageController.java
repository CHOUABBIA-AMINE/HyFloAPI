...
import dz.sh.trc.hyflo.flow.core.service.SlotCoverageService;
...
public class SlotCoverageController {
    ...
    public ResponseEntity<SlotCoverageDTO> getSlotCoverage(
        ...
        SlotCoverageDTO coverage = slotCoverageService.getSlotCoverage(date, slotNumber, structureId);
    ...
    public ResponseEntity<SlotCoverageDTO> getSlotCoverageFiltered(
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date,
            @RequestParam Integer slotNumber,
            @RequestParam Long structureId,
    ...
    public ResponseEntity<Map<Integer, SlotCoverageDTO>> getDailyCoverageSummary(
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date,
            @RequestParam Long structureId) {
        ...
        Map<Integer, SlotCoverageDTO> dailySummary = new java.util.HashMap<>();
