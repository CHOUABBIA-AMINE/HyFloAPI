 ...
 *  @UpdatedOn  : 03-28-2026 — refactor: moved from flow.core.service.impl → flow.workflow.service.impl
 *                             Implements flow.workflow.service.ReadableTargetValidationService.
 *
 *  @Type       : Class
 *  @Layer      : Service / Impl
