...
@NoArgsConstructor
@AllArgsConstructor
public class MeasurementTypeDTO extends GenericDTO<MeasurementType> {
    ...
    @Override
    public MeasurementType toEntity() {
    ...
    @Override
    public void updateEntity(MeasurementType entity) {
    ...
    public static MeasurementTypeDTO fromEntity(MeasurementType entity) {
