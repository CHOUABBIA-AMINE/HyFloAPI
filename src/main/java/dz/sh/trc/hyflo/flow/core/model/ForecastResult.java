...
public class ForecastResult extends GenericModel {
    ...
    @Schema(
            description = "Actual volume realized over the forecast period",
            example = "27250.50",
    ...
    @Schema(
            description = "Absolute error between forecast and actual volume",
            example = "250.50",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
    ...
    @Schema(
            description = "Percentage error between forecast and actual volume",
            example = "0.92",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
    ...
    @Schema(
            description = "Evaluation window or aggregation level (e.g., DAILY, WEEKLY, MONTHLY)",
            example = "DAILY",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED,
            maxLength = 20
    )
