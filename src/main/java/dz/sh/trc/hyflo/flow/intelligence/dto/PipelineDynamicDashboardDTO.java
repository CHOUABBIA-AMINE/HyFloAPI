...
public class PipelineDynamicDashboardDTO {
    ...
    @Schema(description = "[Pipeline] Pipeline ID", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "[Calculated] Overall health status",
            example = "HEALTHY",
            allowableValues = {"HEALTHY", "WARNING", "CRITICAL", "UNKNOWN"})
    private String overallHealth;

    @Schema(description = "[Calculated] Health score (0-100)",
    ...
    @Schema(description = "[Calculated] Pressure status",
            example = "NORMAL",
            allowableValues = {"NORMAL", "LOW", "HIGH", "CRITICAL"})
    private String pressureStatus;

    @Schema(description = "[Calculated] Temperature status",
            example = "NORMAL",
            allowableValues = {"NORMAL", "LOW", "HIGH", "CRITICAL"})
    private String temperatureStatus;

    @Schema(description = "[Calculated] Flow rate status",
            example = "NORMAL",
            allowableValues = {"NORMAL", "LOW", "HIGH", "CRITICAL"})
    ...
    @Schema(description = "[Calculated] Percentage of sensors currently online", example = "97.8")
    ...
    @Schema(description = "[Sensor] Total number of sensors installed", example = "45")
    private Integer totalSensors;

    // ========== DATA QUALITY (Source: Calculated from FlowReading today) ==========

    @Schema(description = "[Calculated] Data completeness percentage for today", example = "95.5")
