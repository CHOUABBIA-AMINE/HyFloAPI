...
public class FlowThreshold extends GenericModel {
	...
	@ManyToOne
	@JoinColumn(name="F_09", referencedColumnName = "F_00", foreignKey=@ForeignKey(name="T_01_03_01_FK_01"), nullable=false)
    private Pipeline pipeline;
    
	@ManyToOne
	@JoinColumn(name="F_10", referencedColumnName = "F_00", foreignKey=@ForeignKey(name="T_01_03_01_FK_01"), nullable=false)
